...
export full, norm, permute, eigenenergies, eigenstates, groundstate, matrix_element, tr, diag
const methods = (:full, :norm, :permute, :eigenenergies, :eigenstates, :groundstate, :matrix_element, :tr, :diag)
